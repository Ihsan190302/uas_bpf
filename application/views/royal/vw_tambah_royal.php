                ...
                <div class="card-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" value="<?= set_value('nama')?>" class="form-control" id="nama" placeholder="Nama Starlight">
                        ...
                        <button type="submit" name="tambah" class="btn btn-primary float-right">Tambah Royal Pass</button>
                    </form>
                </div>
            </div>
        </div>
